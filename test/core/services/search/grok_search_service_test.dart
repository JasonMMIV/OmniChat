...
import 'package:OmniChat/core/services/search/providers/grok_search_service.dart';
import 'package:OmniChat/core/services/search/search_service.dart';
import 'package:OmniChat/utils/brand_assets.dart';
...
void main() {
  group('Grok search service', () {
    ...
    test('parses top-level citations when inline annotations are absent',
        () async {
      final service = GrokSearchService(
        client: MockClient(
