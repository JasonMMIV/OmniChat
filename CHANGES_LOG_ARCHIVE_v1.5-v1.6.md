# OmniChat Archived Changes Log (v1.5.15 to v1.6.8+)

> Detailed entries archived from `CHANGES_LOG.md` on 2026-08-05 to keep the main file readable.
> For the architecture overview, recent versions, and condensed summaries of these archived versions, see [CHANGES_LOG.md](./CHANGES_LOG.md).
...
### 144b. Academic Search Services (arXiv / PubMed / Semantic Scholar)
...
### 145b. Academic Search Provider Brand Icons (arXiv / PubMed / Semantic Scholar)
...
### 143b. Extra High/Max Reasoning Budget Support & Model-Specific Effort Translation
...
### 122a. Dropbox Streaming Upload & Memory Leak Fixes
...
### 142b. Project Usage Statistics & Token Metrics
...
- **Files Modified**:
  ...
  - CHANGES_LOG.md (this entry)
- **Details**:
  - **Granular Token Metrics**: Added promptTokens, completionTokens, and cachedTokens to ChatMessage while maintaining compatibility with historical `totalTokens`.
  ...
  - **Improved Stream Merging**: Updated chat_actions.dart to faithfully propagate usage metrics dynamically across completion chunks.
...
### 142a. Fix Topic Deletion Confirmation Dialog Localization & Mobile Display
...
### 143a. Add "Enable Thinking" Toggle for Greeting Model
...
### 144a. Revert Message Multi-Select & Batch Delete Feature
...
### 145a. Upstream Kelivo v1.1.16 Inline Message Editing & Attachment Support with RikkaHub Header Style
...
- **Files Modified**:
  ...
  - `lib/l10n/app_en.arb`, `lib/l10n/app_zh.arb`, `lib/l10n/app_zh_Hans.arb`, `lib/l10n/app_zh_Hant.arb` (added localization keys for New Chat Page & Greeting Model settings)
  - `CHANGES_LOG.md` (this entry)
- **Details**:
...
### 104a. Add Neuralwatt Built-in API Provider
