...
abstract class AppLocalizations {
  ...
  /// No description provided for @aboutPageAiContentPolicy.
  ///
  /// In en, this message translates to:
  /// **'AI Content Policy'**
  String get aboutPageAiContentPolicy;

  /// No description provided for @aiContentPolicyDisclaimer.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @aiContentPolicyReportAction.
  ///
  /// In en, this message translates to:
  /// **'Open GitHub Issues'**
  String get aiContentPolicyReportAction;

  /// No description provided for @aiContentPolicyReportHint.
  ///
  /// In en, this message translates to:
