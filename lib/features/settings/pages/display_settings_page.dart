    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.fromLTRB(16, 12, 16, 16), children: [
        _iosSectionCard(children: [
          ...
          _iosDivider(context),
          _iosSwitchRow(context, icon: Lucide.Brain, label: l10n.displaySettingsPageShowThinkingCardsTitle, value: sp.showThinkingCards, onChanged: (v) => context.read<SettingsProvider>().setShowThinkingCards(v)),
          _iosDivider(context),
          _iosSwitchRow(context, icon: Lucide.Wrench, label: l10n.displaySettingsPageShowToolCardsTitle, value: sp.showToolCards, onChanged: (v) => context.read<SettingsProvider>().setShowToolCards(v)),
          _iosDivider(context),
          ...
          if (Platform.isAndroid || Platform.isIOS) ...[
            ...
            _iosSwitchRow(
              context,
              icon: Lucide.Sun,
              label: l10n.displaySettingsPageKeepScreenOnDuringGenerationTitle,
              value: sp.keepScreenOnDuringGeneration,
              onChanged: (v) => context.read<SettingsProvider>().setKeepScreenOnDuringGeneration(v),
            ),
          ],
          _iosDivider(context),
